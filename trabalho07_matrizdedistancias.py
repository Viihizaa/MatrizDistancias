# -*- coding: utf-8 -*-
"""Trabalho07_MatrizDeDistancias.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1s59CjqWQyN2rQstuiJCcK55qyQW0cH3n

Aluna: Vitória Izabel Mendes Pinto

Sua tarefa será gerar uma matriz de distância, computando o cosseno do ângulo entre todos os vetores que encontramos usando o tf-idf. Para isso use a seguinte fórmula para o cálculo do cosseno 
...
vetores = [tfidf_1, tfidf_2, tfidf_3, tfidf_4, tfidf_5]

def matriz_distancia(tfidf):
    saida = []
    posicao = 0 
    a = tfidf
    while posicao < 5:
        ...
        saida.append(cos_sim)
    return saida

col1 = matriz_distancia(tfidf_1)
col2 = matriz_distancia(tfidf_2)
col3 = matriz_distancia(tfidf_3)
col4 = matriz_distancia(tfidf_4)
col5 = matriz_distancia(tfidf_5)

"""Impressão da Matriz"""

primeiraLinha = pd.Series(col1)
segundaLinha = pd.Series(col2)
terceiraLinha = pd.Series(col3)
quartaLinha = pd.Series(col4)
quintaLinha = pd.Series(col5)

matrizdist = pd.DataFrame([col1, col2, col3, col4, col5])
matrizdist.index = np.arange(1, len(df) + 1)
matrizdist.index.names = ['VETORES']
matrizdist